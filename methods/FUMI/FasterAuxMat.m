function [Q,Cc,InvDI,InvLbd,C3Cons] = FasterAuxMat(yyh,yym,FBs,FBCs,sizeIM,n_dr,n_dc,InvCov,ER1E,RER2RE,B2Sum) 
...
%C3Cons:    The Cs in Eq. (28)

%If you use this code, please cite the following paper:

% [1] Qi Wei, Nicolas Dobigeon and Jean-Yves Tourneret, "R-FUSE: Robust Fast Fusion of Multi-Band Images Based on Solving a Sylvester Equation", submitted.
%% -------------------------------------------------------------------------
%
...
C3Cons=(fft2(reshape((temp*yyh)',sizeIM)).*FBCs+fft2(reshape((temp*yym)',sizeIM))).*InvLbd;

function [Y_HiBCD,f_record,time_record,count] = HiBCD_NNC(HSI,MSI,F,G,N,varargin)
%=====================================================================
% Programmer: 
...
% -------------------------------------------------------
% Reference: 
% R. Wu, H.-T. Wai and W.-K. Ma, ``Hybrid Inexact BCD for Coupled Structured 
% Matrix Factorization in Hyperspectral Super-Resolution," submitted to IEEE Trans. Signal Processing, 2019. 
%======================================================================
% An implementation of HiBCD (Hybrid Inexact BCD) scheme for NNC CoSMF
% Y_HiBCD = HiBCD_NNC(HSI,MSI,F,G,N,varargin)
%======================================================================
%  Input
%  HSI is the three-way tensor form of the HS image
%  MSI is the Ly-Lx-M_m tensor form of the MS image
%  F is the spectral decimation matrix
%  G is the spatial decimation matrix
%  N is the model order
%  varargin (optional):
%   - MAXITER: maximum iteration
%   - STOPPING: stopping threshold (absolute change of objective value)
%   - S_INIT: initialization of S
%   - A_INIT: initialization of A
%   - A_UPDATE: update rule for A (1-FW, 2-PG, 3-FPG)
%   - S_UPDATE: update rule for S (1-FW, 2-PG, 3-FPG)
%   - GAMMA: regularization parameter
%----------------------------------------------------------------------
%  Output
%  Y_HiBCD is the M-L SR estimation
%========================================================================
S_init = [];
A_init = [];
stopThreshd = 1e-5;
